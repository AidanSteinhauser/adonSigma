...
@Disabled
@TeleOp(name = "nationalNightOut", group = "Adon")
public class nationalNightOut extends OpMode {
    ...
    public void buildPaths() {
        Pose outofboundsrightwards = new Pose(follower.getPose().getX(), -19, follower.getPose().getHeading());
        ...
        Pose outofboundsleftwards = new Pose(follower.getPose().getX(), 19, follower.getPose().getHeading());
        ...
        Pose outofboundsupwards = new Pose(9, follower.getPose().getY(), follower.getPose().getHeading());
        ...
        Pose outofboundsdownwards = new Pose(-9, follower.getPose().getY(), follower.getPose().getHeading());
    ...
    public void loop() {
        ...
        inbounds = follower.getPose().getX() >= -10 && follower.getPose().getX() <= 10 && follower.getPose().getY() >= -10 && follower.getPose().getY() <= 10;
        inboundsdownwards = follower.getPose().getX() >= -10;
        inboundsupwards = follower.getPose().getX() <= 10;
        inboundsrightwards = follower.getPose().getY() >= -20;
        inboundsleftwards = follower.getPose().getY() <= 20;
        ...
        switch (pathState) {
            ...
            case 1:
                follower.followPath(driveToGoalRight, 0.3, false);
                setPathState(5);
                break;

            case 2:
                follower.followPath(driveToGoalUp, 0.3, false);
                setPathState(5);
                break;

            case 3:
                follower.followPath(driveToGoalLeft, 0.3, false);
                setPathState(5);
                break;

            case 4:
                follower.followPath(driveToGoalDown, 0.3, false);
                setPathState(5);
                break;
        ...
        follower.update();
        telemetry.addData("In Field", inbounds);
