...
@TeleOp(name = "LevelOneNationalNightOut", group = "Adon")
public class LevelOneNationalNightOut extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Elapsed Time (s)", (System.currentTimeMillis() - startTime) / 1000.0); // Elapsed time added
        telemetry.update();
    }
